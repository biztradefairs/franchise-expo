...
export default function LoginPage() {
  ...
  const handleAutofillDemo = () => {
    ...
    toast.success("Demo credentials loaded! Click Sign In to log in.");
  };
...
/>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div 
            ...
            className="mb-6 bg-blue-50 border border-blue-200 hover:border-blue-300 hover:bg-blue-100/75 rounded-xl p-4 text-center cursor-pointer transition-all duration-200 group shadow-sm"
          >
            <div className="flex items-center justify-center gap-2 mb-1.5">
              <span className="inline-flex h-2 w-2 rounded-full bg-blue-500 animate-pulse"></span>
              <span className="text-xs font-semibold text-blue-700 uppercase tracking-wider">Demo Credentials</span>
            </div>
            <p className="text-sm text-gray-600">
              Email: <code className="bg-white/80 group-hover:bg-white px-1.5 py-0.5 rounded font-mono text-blue-800 text-xs font-semibold">exhibitor@example.com</code>
            </p>
            <p className="text-sm text-gray-600 mt-1">
              Password: <code className="bg-white/80 group-hover:bg-white px-1.5 py-0.5 rounded font-mono text-blue-800 text-xs font-semibold">password123</code>
            </p>
