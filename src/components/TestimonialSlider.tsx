...
export default function TestimonialSlider() {
  ...
  return (
    <section className="bg-[#5B5E61] py-[30px] px-5 pb-[36px] text-center overflow-hidden max-lg:py-9 max-lg:px-6 max-lg:pb-7 max-sm:py-7 max-sm:px-[18px] max-sm:pb-6">
