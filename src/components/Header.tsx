      ...
      >
        ...
        >
          ...
          <div className="flex flex-col min-[576px]:flex-row min-[576px]:items-center gap-2 min-[576px]:gap-4 shrink-0 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]">
            ...
            {/* Divider — responsive */}
            <div className="w-[1px] bg-[#e0e0e0] shrink-0 h-16 max-[1525px]:h-12 max-[575px]:hidden" />

            {/* Supported By + date — responsive */}
            <div className="flex flex-col justify-center shrink-0">
              <div className="flex items-center gap-2.5 max-[1024px]:gap-1.5 max-[600px]:gap-1 mb-1 max-[1024px]:mb-0.5 font-bold">
                <span className="font-display font-bold uppercase tracking-wider text-[#020202] text-[13px] max-[1024px]:text-[11px] max-[600px]:text-[10px]">Supported By</span>
                <img
                  src="https://www.franchiseexpo.com/images/us-commercial-service.svg"
                  alt="U.S. Commercial Service"
                  className="w-auto object-contain h-[32px] max-[1024px]:h-[26px] max-[600px]:h-[22px]"
                />
              </div>
          ...
          <div className="ml-auto flex items-center max-[1439px]:hidden">
            ...
            <div className="flex gap-4 shrink-0 ml-6 max-[1525px]:ml-3">
              <Link
                ...
                className={`group inline-flex items-center justify-between rounded-full bg-[#FE6B0B] text-[#ffffff] no-underline font-display uppercase tracking-wide shrink-0 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-[1px] gap-4 max-[1525px]:gap-2 ${isScrolled
              ...
              <Link
                ...
                className={`group relative inline-flex items-center justify-start rounded-full bg-[#FE6B0B] text-white no-underline font-display uppercase tracking-wide shrink-0 transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-[1px] ${isScrolled
        ...
        {mobileOpen && (
          ...
          >
            ...
            <div className="flex flex-col items-center gap-4 py-8 px-6 shrink-0">
              ...
              <Link
                href="/register?tab=visitor"
                className="group w-full max-w-[420px] inline-flex items-center justify-between h-[56px] pl-7 pr-[6px] rounded-full bg-[#FE6B0B] text-white no-underline font-display text-[13px] uppercase tracking-wider transition-all duration-300 hover:bg-[#004f99] hover:-translate-y-[1px]"
                onClick={() => setMobileOpen(false)}
              >
            ...
            {/* Supported By + Date (Mobile Menu) */}
            <div className="flex flex-col items-center justify-center shrink-0 mb-8 px-6">
              <div className="flex items-center gap-2.5 mb-2.5 font-bold">
                <span className="font-display font-bold uppercase tracking-wider text-white/70 text-[13px]">Supported By</span>
                <img
                  src="https://www.franchiseexpo.com/images/us-commercial-service.svg"
                  alt="U.S. Commercial Service"
                  className="w-auto object-contain h-[34px] bg-white/10 rounded px-2 py-0.5"
                />
              </div>
